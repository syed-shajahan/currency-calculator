...
import { styled, Theme, width } from '@mui/system';
...
export default function UnstyledButtonCustom({ children }: { children: any }) {
  const Classes = useCustomStyles();
  return <SvgButton className={Classes.button_submit}> {children}</SvgButton>;
}
